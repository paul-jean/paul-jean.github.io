...
var Cell = React.createClass({displayName: "Cell",
    render: function() {
        ...
        return (
            React.createElement("div", {width: dim, height: dim, style: style}
            )
        );
    }
});
...
var Board = React.createClass({displayName: "Board",
    ...
    render: function() {
        ...
        React.createElement("div", null, 
            ...
            React.createElement("div", {width: divSize * gridSize}, 
                a
            )
        ));
    }
...
window.onload = function() {
    ...
    $.getJSON("../images/KanyeWest_4475Web.json", function(data) {
        ...
        React.render(React.createElement(Board, null), $("#grid")[0]);
    }).fail(function(){ console.log('json load failed');});
